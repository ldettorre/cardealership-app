...
import os 
#For setting environment variables, I've decided to use python-decouple 
...
#When in production, ensure the config vars such as email and password are not wrapped in quotes as this causes an auth error.
EMAIL_USE_TLS = True
